package com.example.rebookbookservice.passport;


import com.example.rebookbookservice.exception.UnAuthorizedException;
...
public class PassportUserArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter parameter,
        ...
        return passportDecoder.decode(passport);
    }
}
